...
export interface Analytics {
     ...
     *
     * onQuit alone needs a clean host-initiated quit; real players close the
     * tab or swipe the app away, which is why that path reported almost nothing.
     */
...
export function createAnalytics(config: AnalyticsConfig): Analytics {
    ...
    /** A session ends once; re-armed when the page becomes visible again. */
